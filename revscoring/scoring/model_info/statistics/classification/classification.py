...
class Classification(Statistics):
    ...
    def fit(self, score_labels):
        ...
        self['counts'] = Counts(self.labels, score_labels)
        self['rates'] = Rates(self.labels, self['counts'],
    ...
    def __getitem__(self, key):
        if key in self:
            ...
            try:
                ...
                return opt.optimize_from(self.label_thresholds)
    ...
    def format_str(self, path_tree, ndigits=3, **kwargs):
        ...
        for key in path_tree or self.keys():
            ...
            formatted += self[key].format_str(
                sub_tree, ndigits=ndigits, **kwargs)
